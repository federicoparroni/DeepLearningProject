...
def CrossValidate(k, models, dataset_folder_name, batch_size, num_epochs=200,
                  chat_id="undefined", folders_at_the_same_time=20, save_each_model=False, training_callbacks=[],
                  max_num_of_validation_folders=12, epochs_with_same_data=5, validate_every = 5):
    ...
    for i in range(len(models)):
        ...
        for j in range(k):
            ...
            sum_model_validations_acc += sum(h[1] for h in validation_callback.validation_history)
