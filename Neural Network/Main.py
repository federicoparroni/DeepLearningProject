...
#           validation_split=0.3,  # hold out 30% of the data for validation
#           callbacks=[tbCallBack, earlyStopping, changedata])

facesequence = FaceSequence(X_train, Y_train, batch_size, TRAINING_DATASET_FOLDER_NAME,
                            epochs_with_same_data=5, folders_at_the_same_time = 4, to_avoid=validation_folders_list)
model.fit_generator(generator=facesequence, epochs=20, validation_data=(X_validation, Y_validation), callbacks=[tbCallBack])
